...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (localNotification) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Local Notification Received While App Terminated"
                                                        message:[NSString stringWithFormat:@"userInfo = %@", [[localNotification.userInfo description] stringByReplacingOccurrencesOfString:@"\n" withString:@" "]]
...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Local Notification Received While App Running"
                                                    message:[NSString stringWithFormat:@"userInfo = %@", [[notification.userInfo description] stringByReplacingOccurrencesOfString:@"\n" withString:@" "]]
                                                   delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
    [alert show];
}
